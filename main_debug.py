...
def main(cfg):
    ...
    for epoch in range(num_train_epochs):
        ...
        wandb.log({
            ...
            "val/cross_entropy": val_loss["cross entropy Loss"],
            "val/cluster_loss": val_loss["clst loss"],
            "val/separation_loss": val_loss["sep loss"],
            "val/orthogonal_loss": val_loss["orth loss"],
            "val/l1_loss": val_loss["l1 loss"],
            "accuracy": accu,
